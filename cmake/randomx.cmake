if (WITH_RANDOMX)
    add_definitions(/DTGXM_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (WITH_ASM AND NOT TGXM_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (TGXM_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT TGXM_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (TGXM_OS_WIN OR TGXM_OS_LINUX))
        add_definitions(/DTGXM_FEATURE_MSR)
        add_definitions(/DTGXM_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/DTGXM_FEATURE_MSR)
        remove_definitions(/DTGXM_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()

    if (WITH_PROFILING)
        add_definitions(/DTGXM_FEATURE_PROFILING)

        list(APPEND HEADERS_CRYPTO src/crypto/rx/Profiler.h)
        list(APPEND SOURCES_CRYPTO src/crypto/rx/Profiler.cpp)
    endif()
else()
    remove_definitions(/DTGXM_ALGO_RANDOMX)
endif()
