...
Offical HTTP client for API: http://workers.tgxm.info/
...
* **access-token** [Bearer](https://gist.github.com/tgxm/c75fdd1f8e0f3bac05500be2ab718f8e#file-api-html-L54) access token to secure access to API. Miner support this token only via `Authorization` header.
...
Versions before 2.15 was use another options for API https://github.com/tgxm/tgxm/issues/1007
