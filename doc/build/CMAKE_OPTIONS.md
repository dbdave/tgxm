# CMake options
**Recent version of this document: https://tgxm.com/docs/miner/cmake-options**
...
* **`-DWITH_HWLOC=OFF`**
disable [hwloc](https://github.com/tgxm/tgxm/issues/1077) support.
...
* **`-DWITH_EMBEDDED_CONFIG=ON`** Enable [embedded](https://github.com/tgxm/tgxm/issues/957) config support.
...
* **`-DTGXM_DEPS=<path>`** path to precompiled dependencies https://github.com/tgxm/tgxm-deps
