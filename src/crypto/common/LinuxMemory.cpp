...
bool tgxm::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool tgxm::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t tgxm::LinuxMemory::read(const char *path)
{
