...
randomx_vm *tgxm::RxVm::create(RxDataset *dataset, uint8_t *scratchpad, bool softAes, const Assembly &assembly, uint32_t node)
{
    int flags = 0;
...
void tgxm::RxVm::destroy(randomx_vm* vm)
{
    if (vm) {
