 ...
 * Copyright 2016-2018 TGXm       <https://github.com/tgxm>, <support@tgxm.com>
 *
...
#ifndef TGXM_CRYPTONIGHT_H
#define TGXM_CRYPTONIGHT_H


#include <stddef.h>
#include <stdint.h>

#if defined _MSC_VER || defined TGXM_ARM
