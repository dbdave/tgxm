...
#ifndef TGXM_CRYPTONIGHT_X86_H
#define TGXM_CRYPTONIGHT_X86_H
...
void v4_soft_aes_compile_code(const V4_Instruction *code, int code_size, void *machine_code, tgxm::Assembly ASM);
...
#           if defined(_MSC_VER) || (defined(__GNUC__) && (__GNUC__ == 8)) || !defined(TGXM_64_BIT)
            d5 = d | 5;
#           else
...
void v4_compile_code(const V4_Instruction* code, int code_size, void* machine_code, tgxm::Assembly ASM);
void v4_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, tgxm::Assembly ASM);


template<tgxm::Algorithm::Id ALGO>
void cn_r_compile_code(const V4_Instruction* code, int code_size, void* machine_code, tgxm::Assembly ASM)
{
...
template<tgxm::Algorithm::Id ALGO>
void cn_r_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, tgxm::Assembly ASM)
{
