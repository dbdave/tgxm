...
bool tgxm::BaseConfig::read(const IJsonReader &reader, const char *fileName)
{
    m_fileName = fileName;
...
void tgxm::BaseConfig::printVersions()
{
    char buf[256] = { 0 };
...
void tgxm::BaseConfig::setVerbose(const rapidjson::Value &value)
{
    if (value.IsBool()) {
