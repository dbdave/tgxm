...
tgxm::ConsoleLog::ConsoleLog(const Title &title)
{
    if (!isSupported()) {
        Log::setColors(false);
        return;
...
tgxm::ConsoleLog::~ConsoleLog()
{
    Handle::close(m_tty);
}


void tgxm::ConsoleLog::print(uint64_t, int, const char *line, size_t, size_t size, bool colors)
{
...
bool tgxm::ConsoleLog::isSupported()
{
...
#ifdef TGXM_OS_WIN
bool tgxm::ConsoleLog::isWritable() const
{
