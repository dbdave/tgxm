...
bool tgxm::FileLogWriter::open(const char *fileName)
{
...
bool tgxm::FileLogWriter::write(const char *data, size_t size)
{
    if (!isOpen()) {
        return false;
    }
...
bool tgxm::FileLogWriter::writeLine(const char *data, size_t size)
{
