...
// since 2019.05.16, Version 1.29.0 (Stable) https://github.com/tgxm/tgxm/pull/1889
...
tgxm::Async::Async(Callback callback) : d_ptr(new AsyncPrivate())
{
...
tgxm::Async::Async(IAsyncListener *listener) : d_ptr(new AsyncPrivate())
{
