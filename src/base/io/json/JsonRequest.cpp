...
rapidjson::Document tgxm::JsonRequest::create(const char *method)
{
    return create(++nextId, method);
}


rapidjson::Document tgxm::JsonRequest::create(int64_t id, const char *method)
{
...
uint64_t tgxm::JsonRequest::create(rapidjson::Document &doc, const char *method, rapidjson::Value &params)
{
    return create(doc, ++nextId, method, params);
}


uint64_t tgxm::JsonRequest::create(rapidjson::Document &doc, int64_t id, const char *method, rapidjson::Value &params)
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
