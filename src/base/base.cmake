...
if (WITH_HTTP)
    ...
    add_definitions(/DTGXM_FEATURE_HTTP)
    add_definitions(/DTGXM_FEATURE_API)
else()
    set(HEADERS_BASE_HTTP "")
    set(SOURCES_BASE_HTTP "")
    remove_definitions(/DTGXM_FEATURE_HTTP)
    remove_definitions(/DTGXM_FEATURE_API)
endif()
...
if (WITH_ENV_VARS)
    add_definitions(/DTGXM_FEATURE_ENV)
else()
    remove_definitions(/DTGXM_FEATURE_ENV)
endif()
...
if (WITH_RANDOMX AND WITH_BENCHMARK)
    add_definitions(/DTGXM_FEATURE_BENCHMARK)
    ...
    remove_definitions(/DTGXM_FEATURE_BENCHMARK)
endif()
