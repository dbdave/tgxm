...
tgxm::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const tgxm::String &tgxm::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value tgxm::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
