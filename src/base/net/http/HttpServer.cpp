...
tgxm::HttpServer::HttpServer(const std::shared_ptr<IHttpListener> &listener) :
    m_listener(listener)
{
}


tgxm::HttpServer::~HttpServer()
{
    HttpContext::closeAll();
}


void tgxm::HttpServer::onConnection(uv_stream_t *stream, uint16_t)
{
