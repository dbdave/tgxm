...
bool tgxm::Http::isEqual(const Http &other) const
{
...
rapidjson::Value tgxm::Http::toJSON(rapidjson::Document &doc) const
{
...
void tgxm::Http::load(const rapidjson::Value &http)
{
    if (!http.IsObject()) {
        return;
    }
...
void tgxm::Http::setPort(int port)
{
