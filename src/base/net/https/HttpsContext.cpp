...
tgxm::HttpsContext::HttpsContext(TlsContext *tls, const std::weak_ptr<IHttpListener> &listener) :
...
tgxm::HttpsContext::~HttpsContext() = default;


void tgxm::HttpsContext::append(char *data, size_t size)
{
    if (m_mode == TLS_AUTO) {
...
bool tgxm::HttpsContext::write(BIO *bio)
{
...
void tgxm::HttpsContext::parse(char *data, size_t size)
{
...
void tgxm::HttpsContext::shutdown()
{
    close();
}


void tgxm::HttpsContext::write(std::string &&data, bool close)
{
    m_close = close;
