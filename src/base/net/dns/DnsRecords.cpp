...
const tgxm::DnsRecord &tgxm::DnsRecords::get(DnsRecord::Type prefered) const
{
...
size_t tgxm::DnsRecords::count(DnsRecord::Type type) const
{
    if (type == DnsRecord::A) {
        return m_ipv4.size();
    }
...
void tgxm::DnsRecords::parse(addrinfo *res)
{
    clear();
