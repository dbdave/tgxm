...
int tgxm::App::exec()
{
    if (!m_controller->isReady()) {
        LOG_EMERG("no valid configuration found, try https://tgxm.com/wizard");
...
void tgxm::App::onConsoleCommand(char command)
{
    if (command == 3) {
...
void tgxm::App::onSignal(int signum)
{
    switch (signum)
    {
    case SIGHUP:
