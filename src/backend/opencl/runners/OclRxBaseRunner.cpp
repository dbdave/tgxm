...
tgxm::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
tgxm::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void tgxm::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void tgxm::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t tgxm::OclRxBaseRunner::bufferSize() const
{
...
void tgxm::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void tgxm::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
