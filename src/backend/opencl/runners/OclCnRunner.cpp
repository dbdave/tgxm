...
tgxm::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
size_t tgxm::OclCnRunner::bufferSize() const
{
...
void tgxm::OclCnRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void tgxm::OclCnRunner::set(const Job &job, uint8_t *blob)
{
