...
void tgxm::Cn0Kernel::enqueue(cl_command_queue queue, uint32_t nonce, size_t threads)
{
...
void tgxm::Cn0Kernel::setArgs(cl_mem input, int inlen, cl_mem scratchpads, cl_mem states, uint32_t threads)
{
