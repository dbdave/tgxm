...
void tgxm::FindSharesKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void tgxm::FindSharesKernel::setArgs(cl_mem hashes, cl_mem shares)
{
...
void tgxm::FindSharesKernel::setTarget(uint64_t target)
{
    setArg(1, sizeof(uint64_t), &target);
}


void tgxm::FindSharesKernel::setNonce(uint32_t nonce)
{
