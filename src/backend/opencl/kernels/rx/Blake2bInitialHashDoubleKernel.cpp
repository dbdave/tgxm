...
void tgxm::Blake2bInitialHashDoubleKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void tgxm::Blake2bInitialHashDoubleKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void tgxm::Blake2bInitialHashDoubleKernel::setBlobSize(size_t size)
{
...
void tgxm::Blake2bInitialHashDoubleKernel::setNonce(uint32_t nonce)
{
