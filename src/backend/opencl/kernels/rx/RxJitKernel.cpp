...
void tgxm::RxJitKernel::enqueue(cl_command_queue queue, size_t threads, uint32_t iteration)
{
...
void tgxm::RxJitKernel::setArgs(cl_mem entropy, cl_mem registers, cl_mem intermediate_programs, cl_mem programs, uint32_t batch_size, cl_mem rounding)
{
