...
void tgxm::RxRunKernel::enqueue(cl_command_queue queue, size_t threads, size_t workgroup_size)
{
...
void tgxm::RxRunKernel::setArgs(cl_mem dataset, cl_mem scratchpads, cl_mem registers, cl_mem rounding, cl_mem programs, uint32_t batch_size, const Algorithm &algorithm)
{
