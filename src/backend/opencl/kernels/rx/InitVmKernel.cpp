...
void tgxm::InitVmKernel::enqueue(cl_command_queue queue, size_t threads, uint32_t iteration)
{
...
void tgxm::InitVmKernel::setArgs(cl_mem entropy_data, cl_mem vm_states, cl_mem rounding)
{
