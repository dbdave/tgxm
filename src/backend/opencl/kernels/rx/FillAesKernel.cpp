...
void tgxm::FillAesKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void tgxm::FillAesKernel::setArgs(cl_mem state, cl_mem out, uint32_t batch_size, uint32_t rx_version)
{
