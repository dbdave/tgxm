...
void tgxm::Blake2bHashRegistersKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void tgxm::Blake2bHashRegistersKernel::setArgs(cl_mem out, cl_mem in, uint32_t inStrideBytes)
{
