...
void tgxm::Cn2Kernel::enqueue(cl_command_queue queue, uint32_t nonce, size_t threads)
{
...
void tgxm::Cn2Kernel::setArgs(cl_mem scratchpads, cl_mem states, const std::vector<cl_mem> &branches, uint32_t threads)
{
