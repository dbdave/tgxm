...
tgxm::Cn1Kernel::Cn1Kernel(cl_program program)
    : OclKernel(program, "cn1")
{
}


tgxm::Cn1Kernel::Cn1Kernel(cl_program program, uint64_t height)
...
void tgxm::Cn1Kernel::enqueue(cl_command_queue queue, uint32_t nonce, size_t threads, size_t worksize)
{
...
void tgxm::Cn1Kernel::setArgs(cl_mem input, cl_mem scratchpads, cl_mem states, uint32_t threads)
{
