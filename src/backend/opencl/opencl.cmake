if (BUILD_STATIC AND TGXM_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    add_definitions(/DTGXM_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/DTGXM_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/DTGXM_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/DTGXM_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (TGXM_OS_WIN OR TGXM_OS_LINUX))
        add_definitions(/DTGXM_FEATURE_ADL)
       ...
       remove_definitions(/DTGXM_FEATURE_ADL)
    endif()
else()
    remove_definitions(/DTGXM_FEATURE_OPENCL)
    remove_definitions(/DTGXM_FEATURE_ADL)
