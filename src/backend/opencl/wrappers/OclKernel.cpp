...
tgxm::OclKernel::OclKernel(cl_program program, const char *name) :
    m_name(name)
{
...
tgxm::OclKernel::~OclKernel()
{
    OclLib::release(m_kernel);
}


void tgxm::OclKernel::enqueueNDRange(cl_command_queue queue, uint32_t work_dim, const size_t *global_work_offset, const size_t *global_work_size, const size_t *local_work_size)
{
...
void tgxm::OclKernel::setArg(uint32_t index, size_t size, const void *value)
{
