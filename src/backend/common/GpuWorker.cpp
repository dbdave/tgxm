...
tgxm::GpuWorker::GpuWorker(size_t id, int64_t affinity, int priority, uint32_t deviceIndex) : Worker(id, affinity, priority),
    m_deviceIndex(deviceIndex)
{
}


void tgxm::GpuWorker::storeStats()
{
...
void tgxm::GpuWorker::hashrateData(uint64_t &hashCount, uint64_t &timeStamp, uint64_t &rawHashes) const
{
