if (BUILD_STATIC AND TGXM_OS_UNIX AND WITH_CUDA)
...
if (WITH_CUDA)
    add_definitions(/DTGXM_FEATURE_CUDA)
   ...
   if (WITH_NVML AND NOT APPLE)
       add_definitions(/DTGXM_FEATURE_NVML)
       ...
       remove_definitions(/DTGXM_FEATURE_NVML)
   endif()
   ...
   if (WITH_KAWPOW)
    ...
    remove_definitions(/DTGXM_FEATURE_CUDA)
    remove_definitions(/DTGXM_FEATURE_NVML)
