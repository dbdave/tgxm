...
void tgxm::ConfigTransform::finalize(rapidjson::Document &doc)
{
...
void tgxm::ConfigTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
...
void tgxm::ConfigTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::HugePagesKey: /* --no-huge-pages */
...
void tgxm::ConfigTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    using namespace rapidjson;
...
#ifdef TGXM_FEATURE_BENCHMARK
void tgxm::ConfigTransform::transformBenchmark(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
    case IConfig::AlgorithmKey: /* --algo */
