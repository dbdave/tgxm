...
void tgxm_ar2_fill_segment_ssse3(const argon2_instance_t *instance, argon2_position_t position)
{
    fill_segment_128(instance, position);
}

extern int cpu_flags_has_ssse3(void);
int tgxm_ar2_check_ssse3(void) { return cpu_flags_has_ssse3(); }

#else

void tgxm_ar2_fill_segment_ssse3(const argon2_instance_t *instance, argon2_position_t position) {}
int tgxm_ar2_check_ssse3(void) { return 0; }
