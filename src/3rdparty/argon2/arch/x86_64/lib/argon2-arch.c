...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       tgxm_ar2_check_sse2,     tgxm_ar2_fill_segment_sse2 },
        { "SSSE3",      tgxm_ar2_check_ssse3,    tgxm_ar2_fill_segment_ssse3 },
        { "XOP",        tgxm_ar2_check_xop,      tgxm_ar2_fill_segment_xop },
        { "AVX2",       tgxm_ar2_check_avx2,     tgxm_ar2_fill_segment_avx2 },
        { "AVX-512F",   tgxm_ar2_check_avx512f,  tgxm_ar2_fill_segment_avx512f },
    };
