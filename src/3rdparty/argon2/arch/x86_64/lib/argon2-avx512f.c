...
void tgxm_ar2_fill_segment_avx512f(const argon2_instance_t *instance, argon2_position_t position)
{
    ...
    for (i = starting_index; i < instance->segment_length;
         ...
         */
        position.index = i;
        ref_index = tgxm_ar2_index_alpha(instance, &position, pseudo_rand & 0xFFFFFFFF, ref_lane == position.lane);
...
int tgxm_ar2_check_avx512f(void) { return cpu_flags_has_avx512f(); }

#else

void tgxm_ar2_fill_segment_avx512f(const argon2_instance_t *instance, argon2_position_t position) {}
int tgxm_ar2_check_avx512f(void) { return 0; }
