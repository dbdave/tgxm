...
void tgxm_ar2_fill_segment_avx2(const argon2_instance_t *instance, argon2_position_t position)
{
...
int tgxm_ar2_check_avx2(void) { return cpu_flags_has_avx2(); }

#else

void tgxm_ar2_fill_segment_avx2(const argon2_instance_t *instance, argon2_position_t position) {}
int tgxm_ar2_check_avx2(void) { return 0; }
