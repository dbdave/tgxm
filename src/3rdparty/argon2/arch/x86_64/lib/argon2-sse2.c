...
void tgxm_ar2_fill_segment_sse2(const argon2_instance_t *instance, argon2_position_t position)
{
    fill_segment_128(instance, position);
}

extern int cpu_flags_has_sse2(void);
int tgxm_ar2_check_sse2(void) { return cpu_flags_has_sse2(); }

#else

void tgxm_ar2_fill_segment_sse2(const argon2_instance_t *instance, argon2_position_t position) {}
int tgxm_ar2_check_sse2(void) { return 0; }
