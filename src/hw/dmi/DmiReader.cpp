...
rapidjson::Value tgxm::DmiReader::toJSON(rapidjson::Document &doc) const
{
    rapidjson::Value obj;
    toJSON(obj, doc);
...
void tgxm::DmiReader::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
...
bool tgxm::DmiReader::decode(uint8_t *buf, const Cleanup &cleanup)
{
...
bool tgxm::DmiReader::decode(uint8_t *buf)
{
    if (!buf) {
        return false;
    }
