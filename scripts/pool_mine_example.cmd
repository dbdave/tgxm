...
::
:: Format:
::	tgxm.exe -o <pool address>:<pool port> -u <pool username/wallet> -p <pool password>
::
:: Fields:
...
cd /d "%~dp0"
tgxm.exe -o xmrpool.eu:3333 -u 48edfHu7V9Z84YzzMa6fUueoELZ9ZRXq9VetWzYGzKt52XU5xvqgzYnDK9URnRoJMk1j8nLwEVsaSWJ4fhdUyZijBGUicoD -p x
pause
